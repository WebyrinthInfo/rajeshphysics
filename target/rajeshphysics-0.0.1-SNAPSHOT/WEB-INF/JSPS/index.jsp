			...
			<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
				<div class="service-item text-center pt-3">
					<div class="p-4">
						...
						<h5 class="mb-3">Highly Skilled Teachers</h5>
			...
			<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
				<div class="service-item text-center pt-3">
					<div class="p-4">
						...
						<h5 class="mb-3">Books / PDF Notes</h5>
						<p>Diam elitr kasd sed at elitr sed ipsum justo dolor sed
							clita amet diam</p>
					</div>
				</div>
			...
			<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s"
				...
				<div class="position-relative h-100">
					<img class="img-fluid position-absolute w-100 h-100"
						src="img/owner.png" alt="" style="object-fit: cover;">
				</div>
			</div>
			<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
				<h6 class="section-title bg-white text-start text-primary pe-3">About
					Us</h6>
				<h1 class="mb-4">Welcome to Rajesh Physics</h1>
				<p class="mb-4">Rajesh Physics of Education is an online
					educational portal imparting knowledge through various interactive
					modes of learning across the globe. We offer learning programs for
					students of KG-12. We also gear up aspirants for competitive exams
					nationally and internationally.</p>
				<p class="mb-4">We, at Rajesh Physics, aim to create a welcoming
					and exciting environment where we provide rich and diverse content
					through excellent and innovative methods. We believe in inspiring
					students to achieve their best in academics through PIE.</p>
				<div class="row gy-2 gx-4 mb-4">
					<div class="col-sm-6">
						<p class="mb-0">
							<i class="fa fa-arrow-right text-primary me-2"></i>Highly Skilled
							Teachers
						</p>
					</div>
					<div class="col-sm-6">
						<p class="mb-0">
							<i class="fa fa-arrow-right text-primary me-2"></i>Recorded
							Lectures
						</p>
					</div>
					<div class="col-sm-6">
						<p class="mb-0">
							<i class="fa fa-arrow-right text-primary me-2"></i>Online Exam
							Test
						</p>
					</div>
					<div class="col-sm-6">
						<p class="mb-0">
							<i class="fa fa-arrow-right text-primary me-2"></i>Live Classes
						</p>
					</div>
					<div class="col-sm-6">
						<p class="mb-0">
							<i class="fa fa-arrow-right text-primary me-2"></i>PDF Notes
						</p>
					</div>
					<div class="col-sm-6">
						<p class="mb-0">
							<i class="fa fa-arrow-right text-primary me-2"></i>24*7 hours
							Support
						</p>
					</div>
				</div>
...
<!-- Picture and GIF Background -->
<div class="container-xxl py-5">
	<div class="container">
		<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
			<h5 class="section-title bg-white text-center text-primary px-3">Why
				Rajesh Physics ...?</h5>
			<h1 class="mb-5">Students Here Follow This Secret Recipe.</h1>
		</div>

		<div class="container text-center"
			style="width: 100%; margin: auto; background: url('img/wybg.gif'); background-repeat: repeat background-position: 984px -32px; background-size: 30% 70%;">
			<img src="img/wy.png" alt="wy.png" class="img-fluid"
...
<div class="container-xxl py-5">
	<div class="container">
		<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
			...
			<h1 class="mb-5">You Can Choose To Get Education</h1>
		</div>
...
<div class="container-xxl py-5">
	<div class="container">
		<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
			...
			<h1 class="mb-5">Highly Expert Faculties</h1>
		</div>
		<div class="row g-4">
					...
					<div class="position-relative d-flex justify-content-center"
						...
						<div class="bg-light d-flex justify-content-center pt-2 px-1">
							<a class="btn btn-sm-square btn-primary mx-1" href=""><i
								...
								class="btn btn-sm-square btn-primary mx-1" href="https://www.instagram.com/rajesh_physics_151998/profilecard/?igsh=ODZsZHNsZGYxcHY2"><i
								class="fab fa-instagram"></i></a>
						</div>
					</div>
					<div class="text-center p-4">
						<h5 class="mb-0">Rajesh Kumar</h5>
						<small>C.E.O OF Institution (Physics Export)</small>
					</div>
				</div>
			</div>
			...
			<div class="testimonial-item text-center">
				...
				<div class="testimonial-text bg-light text-center p-4">
					<p class="mb-0">Tempor erat elitr rebum at clita. Diam dolor
						diam ipsum sit diam amet diam et eos. Clita erat ipsum et lorem et
						sit.</p>
				</div>
			</div>
			<div class="testimonial-item text-center">
